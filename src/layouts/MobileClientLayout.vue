<template>
  <q-layout view="hHh lpR fFf" class="bg-grey-1 mobile-layout">
      ...
      <q-scroll-area class="fit">
        <div class="drawer-header">
          ...
          <div class="drawer-user-info">
            <div class="user-name">{{ userName || 'Utilizador' }}</div>
            <div class="user-type">{{ userType || 'Cliente' }}</div>
          </div>
        </div>
...
const userName = computed(() => authStore.user?.nome || 'Utilizador')
